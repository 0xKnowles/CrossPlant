...
inline SettingInfo buildSleepScreenSetting() {
  SettingInfo s = SettingInfo::Enum(
      ...
      {StrId::STR_NONE_OPT, StrId::STR_DARK, StrId::STR_LIGHT, StrId::STR_CUSTOM, StrId::STR_COVER,
       ...
       StrId::STR_THEME_MINIMAL_STATS, StrId::STR_THEME_DASHBOARD, StrId::STR_QUICK_RESUME, StrId::STR_SLEEP_PET,
       StrId::STR_SLEEP_ROTATING},
  ...
  s.withEnumRawValues({
      ...
      static_cast<uint8_t>(CrossPointSettings::PET_SLEEP),
      static_cast<uint8_t>(CrossPointSettings::ROTATING),
  });
  return s;
}
  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    add(SettingInfo::Enum(
            ...
            {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_MINIMAL, StrId::STR_THEME_DASHBOARD,
             StrId::STR_THEME_PLANT_DASH, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED,
            ...
            .withEnumRawValues({CrossPointSettings::UI_THEME::CLASSIC, CrossPointSettings::UI_THEME::MINIMAL,
                                CrossPointSettings::UI_THEME::DASHBOARD, CrossPointSettings::UI_THEME::PLANT_DASH,
    ...
    add(SettingInfo::Enum(StrId::STR_SHORT_PWR_BTN, &CrossPointSettings::shortPwrBtn,
            ...
            .withEnumRawValues({CrossPointSettings::IGNORE,
                                ...
                                CrossPointSettings::VIRTUAL_PET}));
    ...
    add(SettingInfo::Enum(StrId::STR_LONG_PRESS_MENU_ACTION, &CrossPointSettings::longPressMenuAction,
            ...
            .withEnumRawValues({CrossPointSettings::LONG_MENU_OFF,
                                ...
                                CrossPointSettings::LONG_MENU_VIRTUAL_PET}));
    ...
    add(SettingInfo::Toggle(StrId::STR_BATTERY, &CrossPointSettings::statusBarBattery, "statusBarBattery",
                            StrId::STR_CUSTOMISE_STATUS_BAR));
    add(SettingInfo::Toggle(StrId::STR_DEW_DROPS, &CrossPointSettings::statusBarDewDrops, "statusBarDewDrops",
                            StrId::STR_CUSTOMISE_STATUS_BAR));
...
inline std::vector<SettingInfo> buildSystemSettingsParentList(const std::vector<SettingInfo>& allSettings) {
  ...
  systemSettings.push_back(SettingInfo::Action(StrId::STR_VIRTUAL_PET, SettingAction::VirtualPet));
